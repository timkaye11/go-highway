...
// ReduceSum_AVX512_Uint64x8 returns the sum of all 8 uint64 elements.
func ReduceSum_AVX512_Uint64x8(v archsimd.Uint64x8) uint64 {
	lo := v.GetLo() // Uint64x4
	hi := v.GetHi() // Uint64x4
	return ReduceSum_AVX2_Uint64x4(lo) + ReduceSum_AVX2_Uint64x4(hi)
}
